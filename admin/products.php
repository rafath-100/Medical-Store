...
<!-- removed content of this file starts here -->
    <div class="row">
      ...
      <div class="col-sm-6">
      <form role="form" action="../adminproducthandler.php" method="POST" enctype="multipart/form-data">
        <h1>Products</h1>
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="price" placeholder="Actualprice" name="actualprice">
          </div>
          <div class="form-group">
