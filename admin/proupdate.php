...
<!-- removed content of this file starts here -->
    <div class="row">
      ...
      <div class="col-sm-6">
      <form role="form" action="../adminproupdatehandler.php" method="POST" enctype="multipart/form-data">
        <?php
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label for="price">Actualprice</label>
            <input type="text" class="form-control" id="price" placeholder="Actualprice" name="actualprice" value="<?php echo $final['actualprice'] ?>">
          </div>
          <div class="form-group">
            <label for="price">Discount</label>
            <input type="text" class="form-control" id="price" placeholder="Discount" name="discount" value="<?php echo $final['discount'] ?>">
          </div>
          <div class="form-group">
